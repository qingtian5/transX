...
class Config(object):
    ...
    def _init_train_config(self):
        ...
        self.train_data_path = os.path.join(self.base_path, self.data, 'train_test.txt')
        self.eval_data_path = os.path.join(self.base_path, self.data, 'valid_test.txt')
        self.entity2id_path = os.path.join(self.base_path, self.data, 'entity2id_test.txt')
        self.relation2id_path = os.path.join(self.base_path, self.data, 'relation2id_test.txt')
